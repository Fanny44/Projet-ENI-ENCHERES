...
public interface DAOArticleVendu extends DAO<ArticleVendu> {
	 ...
	 * 
	 * @param categorie
	 * @return liste d'article correspondant au numéro de catégorie passé en
	 *         paramètre
	 * @throws DALException
	 */
	 ...
	 * @param nom
	 * @param categorie
	 * @return liste d'article correspondant au numéro de catégorie et au nom passé
	 *         en paramètre
	 * @throws DALException
	 */
	 ...
	 * 
	 * @param noUtilisateur
	 * @return liste d'enchère dont l'utilisater passé en paramètre à fait au moins
	 *         une enchère
	 * @throws DALException
	 */
