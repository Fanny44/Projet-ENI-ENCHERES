...
//avoir s'il ne manque pas 		
			try {
				...
				throw new BLLException(
						"Une erreur est survenue pendant l'insertion de l'article" + " " + e.getMessage());
			}
		}
	}
	...
	public List<ListeEncheres> getEncheresFaite(int noUtilisateur) throws BLLException {
		...
		try {
			...
			throw new BLLException(
					"Erreur sur la récupération de la liste d'article vendu dont l'user à fait au moins une enchère"
							+ e.getMessage());
		}
		return ListeArticle;
	}
	...
	public List<ListeEncheres> getMesVentesNonCommences(int noUtilisateur) throws BLLException {
		...
		try {
			...
			throw new BLLException(
					"Erreur sur la récupération de la liste d'article vendu vente non commencés par l'user"
							+ e.getMessage());
		}
		return ListeArticle;
	}
