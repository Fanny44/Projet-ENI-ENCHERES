...
<jsp:include page="${ContratUrl.URL_FRG_BALISE_HEAD}">
	...
	<form id="formRecherche" action="Accueil" method="post">
		...
		<div>
			...
			<div id="choix">	
				<input class="choixRadio" type="radio" name="choix" value="achats" id="achats" onclick="clcBtn();">&nbsp;Achats<br>
				<div id="achat">
					<input class="radioAchat" type="radio" name="achat" value="mesEn">&nbsp;Toutes mes enchères<br>
				...
				<input class="choixRadio" type="radio" name="choix" value="ventes" id="ventes" onclick="clcBtn();">&nbsp;Mes ventes<br>
				<div id="vente">
